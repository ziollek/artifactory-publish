...
"use strict";
module.exports = JSON.parse('{"name":"@gh-stats/reporter","version":"1.0.4","description":"gh-stats reporter package","main":"index.js","author":"Bartosz Gałek","repository":"git://github.com/bgalek/gh-stats.git","license":"ISC","scripts":{"postversion":"git push --follow-tags","test":"jest"},"devDependencies":{"eslint":"^7.32.0","eslint-plugin-jest":"^24.4.0","jest":"^27.0.6","nock":"^13.1.1"},"_resolved":"https://registry.npmjs.org/@gh-stats/reporter/-/reporter-1.0.4.tgz","_integrity":"sha512-onWykTpJ3HIaheIcegPkN9oWaYUeCb114aUb4G7Vsr9Z+5mmJzLuee13sdo2EZ0JqJDjIlhZWAzDSa2FLTA09Q==","_from":"@gh-stats/reporter@1.0.4"}');
...
const { version } = __nccwpck_require__(6915);
...
module.exports = {
  ...
  clean: __nccwpck_require__(7552),
...
const { compressDirectory } = __nccwpck_require__(6510);
...
(() => {
const core = __nccwpck_require__(2186);
const { reportAction } = __nccwpck_require__(7605);
const { deployArtifactUrl, provisioningArtifactUrl } = __nccwpck_require__(8848);
const { publishProvisioning } = __nccwpck_require__(8860);
const { publishBuildDir, publishDistributions } = __nccwpck_require__(2718);
const { getBranchName } = __nccwpck_require__(1647);
